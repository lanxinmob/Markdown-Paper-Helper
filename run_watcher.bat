...
start "MarkdownWatcherService" "C:\Users\N\AppData\Local\Programs\Python\Python313\pythonw.exe" "D:\vscode workplace\fun\article auto_reco\watcher.py" --repo "D:\poem" 
